...
class WHShippingBasicTab:
    ...
    out_date_datepicker = Datepicker((By.XPATH, "//*[@ng-model='vm.wh.data.shipment_date']"))

class WHShippingAccountingBillingBasedTab:
...
class WHShippingAccountingInvoiceBasedTab:
