@MASCOT
Feature: [Accounting Wizard] Accounting Wizard Acceptance Test in Air Export module

    Accounting Wiazrd acceptance test in AE module, look up ticket GQT-161 for detail
    ...
    Scenario: If 'Accounting Wizard' function is on, then user can switch 'accounting mode'
        ...
        When the user is in New Air Export Shipment page
    ...
    Scenario: The user create some AR/AP in AI, and the statistical data show correctly in both 'Billing Based' and 'Invoice Based'
        ...
        And the user has a AE MAWB with 1 HAWB as 'A' with only required fields filled
        When the user goes to AE Accounting Tab (Invoice Based)
        And the user clicks AE MAWB 'Create AR' button
        ...
        And the user clicks AE HAWB 'Create AP' button
        ...
        Then the AE MAWB amounts and profits should show correctly in Invoice Based
            | Revenue | Cost | Balance | Total Profit Amount |
            | 10.00   | 0.00 | 10.00   | -10.00              |
        And the AE HAWB amounts and profits should show correctly in Invoice Based
            | Revenue | Cost  | Balance | HAWB Profit Amount |
            | 0.00    | 20.00 | -20.00  | -10.00             |
        When the user goes to AE Accounting Tab (Billing Based)
        Then the AE MAWB amounts and profits should show correctly in Billing Based
            | MAWB Revenue | MAWB Cost | MAWB Amount | Total Profit Amount |
            | 10.00        | 0.00      | 10.00       | -10.00              |
        And the AE HAWB amounts and profits should show correctly in Billing Based
            | HAWB Revenue | HAWB Cost | HAWB Amount | Profit Amount |
            | 0.00         | 20.00     | -20.00      | -10.00        |

        # Step 5
        When the user goes to AE Accounting Tab (Invoice Based)
        And the user clicks AE MAWB 'Create AP' button
        And the user input AP Billing Information
            | Vendor               |
            | {randomTradePartner} |
        And the user add freights to AP
            ...
            | ALL IN CHARGE | 200  |
        And the user click save button
        And the user clicks AE HAWB 'Create AR' button
        And the user input AR Billing Information
            | Bill to              |
            | {randomTradePartner} |
        And the user add freights to AR
        ...
        # Step 6
        When the user delete all freights in AE MAWB revenue Billing Based
        And the user delete all freights in AE MAWB cost Billing Based
        And the user delete all freights in AE HAWB revenue Billing Based
        And the user delete all freights in AE HAWB cost Billing Based
        And the user clicks save button in AE Accounting Billing Based
        Then AE MAWB has no invoice in Billing Based
        And AE HAWB has no invoice in Billing Based
        When the user goes to AE Accounting Tab (Invoice Based)
        Then AE MAWB has no invoice in Invoice Based
        And AE HAWB has no invoice in Invoice Based
    ...
    Scenario: Blocking, draft, and DC supporting test
        ...
        And the user add freights to AR
            ...
            | Chassis Charge    | 50   |
        And the user click save button
        And the user clicks AE HAWB 'Create DC' button
        ...
        When the user unchecks AE Accounting (Invoice Based) MAWB 'Include Draft Amount' checkbox
        Then the AE MAWB amounts and profits should show correctly in Invoice Based
            | Revenue | Cost | Balance | Total Profit Amount |
            | 0.00    | 0.00 | 0.00    | 50.00               |
        When the user unchecks AE Accounting (Invoice Based) HAWB 'Include Draft Amount' checkbox
        Then the AE HAWB amounts and profits should show correctly in Invoice Based
            | Revenue | Cost   | Balance | HAWB Profit Amount |
            | 250.00  | 200.00 | 50.00   | 50.00              |
        When the user goes to AE Accounting Tab (Billing Based)
        And the user checks AE Accounting (Billing Based) MAWB 'Include Draft Amount' checkbox
        Then the AE MAWB amounts and profits should show correctly in Billing Based
            | MAWB Revenue | MAWB Cost | MAWB Amount | Total Profit Amount |
            | 10.00        | 0.00      | 10.00       | 50.00               |
        When the user checks AE Accounting (Billing Based) HAWB 'Include Draft Amount' checkbox
        Then the AE HAWB amounts and profits should show correctly in Billing Based
            | HAWB Revenue | HAWB Cost | HAWB Amount | Profit Amount |
            | 150.00       | 0.00      | 150.00      | 50.00         |
        When the user unchecks AE Accounting (Billing Based) MAWB 'Include Draft Amount' checkbox
        Then the AE MAWB amounts and profits should show correctly in Billing Based
            | MAWB Revenue | MAWB Cost | MAWB Amount | Total Profit Amount |
            | 0.00         | 0.00      | 0.00        | 50.00               |
        When the user unchecks AE Accounting (Billing Based) HAWB 'Include Draft Amount' checkbox
        Then the AE HAWB amounts and profits should show correctly in Billing Based
            | HAWB Revenue | HAWB Cost | HAWB Amount | Profit Amount |
            | 150.00       | 0.00      | 150.00      | 50.00         |

        # Step 8
        When the user blocks AE HAWB revenue(1) in Accounting Billing Based
        Then AE HAWB revenues listed below should be uneditable in Accounting Billing Based
            | No. |
            | 1   |
            | 2   |
            | 3   |
    ...
    Scenario: Special value test
        ...
        And the user has a AE MAWB with 1 HAWB as 'A' with only required fields filled
        When the user goes to AE Accounting Tab (Billing Based)
        When the user adds freights to AE MAWB revenue
            | Bill to     | Freight code | Volume | Rate |
            | SHIPPER9191 | APHIS        | 9.293  | 165  |
        And the user clicks save button in AE Accounting Billing Based
        Then values in AE MAWB revenue should be correct
            | No. | Amount  |
            | 1   | 1533.35 |
        When the user adds freights to AE HAWB revenue
            | Bill to     | Freight code | Volume | Rate |
            | SHIPPER9191 | APHIS        | 9.293  | 165  |
        And the user clicks save button in AE Accounting Billing Based
        Then values in AE HAWB revenue should be correct
            | No. | Amount  |
            | 1   | 1533.35 |
    ...
    Scenario: Creation, deletion, editing, and order test in accounting wizard
        ...
        And the user adds freights to AE MAWB cost
            | Bill to  | Freight code      | Volume | Rate |
            | RAIL9191 | APHIS             | 1      | 1    |
            | RAIL9191 | APHIS             | 1      | 2    |
            | RAIL9191 | ALL IN CHARGE     | 1      | 3    |
        ...
        Then values in AE MAWB revenue should be correct
            ...
            | 19  | 4      |
            | 20  | 5      |
        Then values in AE MAWB cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
        ...
        # Step 12
        When the user deletes freights in AE MAWB revenue
            | No. |
            | 5   |
            | 6   |
            | 7   |
        And the user adds freights to AE MAWB cost
            ...
            | RAMP9191 | CCAM         | 1      | 200  |
        And the user clicks save button in AE Accounting Billing Based
        And the user changes currency of freights in AE MAWB revenue
            | No. | Currency |
            | 8   | GBP      |
            | 9   | GBP      |
            | 10  | GBP      |
        ...
        Then values in AE MAWB revenue should be correct
            ...
            | 16  | EUR      | 4      |
            | 17  | EUR      | 5      |
        And values in AE MAWB cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
    ...
    Scenario: Freights' order, and 'copy to' function test
        ...
        And the user has a AE MAWB with 1 HAWB as 'A' with only required fields filled
        When the user goes to AE Accounting Tab (Billing Based)
        And the user adds freights to AE HAWB cost
            | Bill to  | Freight code      | Volume | Rate |
            | RAIL9191 | APHIS             | 1      | 1    |
            | RAIL9191 | APHIS             | 1      | 2    |
            | RAIL9191 | ALL IN CHARGE     | 1      | 3    |
        ...
        And the user clicks save button in AE Accounting Billing Based
        Then values in AE HAWB cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
        ...
        # Step 15
        When the user copys freights from AE HAWB cost to HAWB revenue
            | No. |
            | 1   |
            | 2   |
            | 3   |
            ...
            | 9   |
            | 10  |
        And the user input freights information to AE HAWB revenue
            | No. | Bill to     |
            | 1   | SHIPPER9191 |
            | 2   | SHIPPER9191 |
            | 3   | SHIPPER9191 |
            ...
            | 10  | SHIPPER9191 |
        And the user clicks save button in AE Accounting Billing Based
        And the user changes currency of freights in AE HAWB revenue
            | No. | Currency |
            | 1   | EUR      |
        And the user deletes freights in AE HAWB revenue
            | No. |
            | 2   |
            | 3   |
        And the user adds freights to AE HAWB revenue
            | Bill to  | Freight code | Volume | Rate |
            | RAIL9191 | APHIS        | 1      | 11   |
        And the user deletes freights in AE HAWB cost
            | No. |
            | 1   |
        And the user adds freights to AE HAWB cost
            | Bill to  | Freight code | Volume | Rate |
    ...
    Scenario Outline: AE invoice Print style test
        # Step 16
        Given the company set 'Invoice Accounting Wizard Form Style' to '<style>' in 'Company Management' page
        And the user is a 'Operator'
        And the user has a AE MAWB with 1 HAWB as 'A' with only required fields filled
        When the user goes to AE Accounting Tab (Billing Based)
        And the user adds freights to AE MAWB revenue
            | Bill to  | Freight code | Volume | Rate |
            | RAIL9191 | APHIS        | 1      | 1    |
        And the user clicks save button in AE Accounting Billing Based
        When the user clicks 'Action -> Print / Mail' to AE MAWB revenue(1)
    ...
    Scenario: Permission test
        ...
        And the user clicks save button in AE Accounting Billing Based
        And the user blocks AE MAWB revenue(1) in Accounting Billing Based
        ...
        Given the user is a 'Operator'
        When the user goes back to AE Shipment 'A'
        And the user goes to AE Accounting Tab (Billing Based)
        Then the unblock bottom in AE MAWB revenue(1) should be invisible
        And the block bottom in AE MAWB revenue(2) should be invisible
        When the user changes currency of freights in AE MAWB revenue
            | No. | Currency |
            | 2   | EUR      |
        ...
        And the user deletes freights in AE MAWB revenue
            | No. |
            | 2   |
        # ? KNOWN ISSUE OLC-5051
        #  Then the save button in AE shipment Accounting Billing Based should be disabled
