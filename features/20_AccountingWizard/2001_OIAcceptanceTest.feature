@MASCOT
Feature: [Accounting Wizard] Accounting Wizard Acceptance Test in Ocean Import module

    Accounting Wiazrd acceptance test in OI module, look up ticket GQT-161 for detail
    ...
    Scenario: If 'Accounting Wizard' function is on, then user can switch 'accounting mode'
        ...
        When the user is in New Ocean Import Shipment page
    ...
    Scenario: The user create some AR/AP in OI, and the statistical data show correctly in both 'Billing Based' and 'Invoice Based'
        # Step 4
        Given the user is a 'Operator'
        And the user has a OI MBL with 1 HBL as 'A' with only required fields filled
        When the user goes to OI Accounting Tab (Invoice Based)
        ...
        Then the OI MBL amounts and profits should show correctly in Invoice Based
            | Revenue | Cost | Balance | Total Profit Amount |
            | 10.00   | 0.00 | 10.00   | -10.00              |
        And the OI HBL amounts and profits should show correctly in Invoice Based
            | Revenue | Cost  | Balance | HB/L Profit Amount |
            | 0.00    | 20.00 | -20.00  | -10.00             |
        When the user goes to OI Accounting Tab (Billing Based)
        Then the OI MBL amounts and profits should show correctly in Billing Based
            | MB/L Revenue | MB/L Cost | MB/L Amount | Total Profit Amount |
            | 10.00        | 0.00      | 10.00       | -10.00              |
        And the OI HBL amounts and profits should show correctly in Billing Based
        ...
        # Step 6
        When the user delete all freights in OI MBL revenue Billing Based
        And the user delete all freights in OI MBL cost Billing Based
        And the user delete all freights in OI HBL revenue Billing Based
        And the user delete all freights in OI HBL cost Billing Based
        And the user clicks save button in OI Accounting Billing Based
        Then OI MBL has no invoice in Billing Based
        And OI HBL has no invoice in Billing Based
        When the user goes to OI Accounting Tab (Invoice Based)
        Then OI MBL has no invoice in Invoice Based
        And OI HBL has no invoice in Invoice Based
    ...
    Scenario: Blocking, draft, and DC supporting test
        ...
        And the user add freights to AR
            ...
            | Chassis Charge    | 50   |
        And the user click save button
        And the user clicks OI HBL 'Create DC' button
        ...
        When the user unchecks OI Accounting (Invoice Based) MBL 'Include Draft Amount' checkbox
        Then the OI MBL amounts and profits should show correctly in Invoice Based
            | Revenue | Cost | Balance | Total Profit Amount |
            | 0.00    | 0.00 | 0.00    | 50.00               |
        When the user unchecks OI Accounting (Invoice Based) HBL 'Include Draft Amount' checkbox
        Then the OI HBL amounts and profits should show correctly in Invoice Based
            | Revenue | Cost   | Balance | HB/L Profit Amount |
            | 250.00  | 200.00 | 50.00   | 50.00              |
        When the user goes to OI Accounting Tab (Billing Based)
        And the user checks OI Accounting (Billing Based) MBL 'Include Draft Amount' checkbox
        Then the OI MBL amounts and profits should show correctly in Billing Based
            | MB/L Revenue | MB/L Cost | MB/L Amount | Total Profit Amount |
            | 10.00        | 0.00      | 10.00       | 50.00               |
        When the user checks OI Accounting (Billing Based) HBL 'Include Draft Amount' checkbox
        Then the OI HBL amounts and profits should show correctly in Billing Based
            | HB/L Revenue | HB/L Cost | HB/L Amount | Profit Amount |
            | 150.00       | 0.00      | 150.00      | 50.00         |
        When the user unchecks OI Accounting (Billing Based) MBL 'Include Draft Amount' checkbox
        Then the OI MBL amounts and profits should show correctly in Billing Based
            | MB/L Revenue | MB/L Cost | MB/L Amount | Total Profit Amount |
            | 0.00         | 0.00      | 0.00        | 50.00               |
        When the user unchecks OI Accounting (Billing Based) HBL 'Include Draft Amount' checkbox
        Then the OI HBL amounts and profits should show correctly in Billing Based
            | HB/L Revenue | HB/L Cost | HB/L Amount | Profit Amount |
            | 150.00       | 0.00      | 150.00      | 50.00         |

        # Step 8
        When the user blocks OI HBL revenue(1) in Accounting Billing Based
        Then OI HBL revenues listed below should be uneditable in Accounting Billing Based
            | No. |
            | 1   |
            | 2   |
            | 3   |
    ...
    Scenario: Special value test
        ...
        And the user has a OI MBL with 1 HBL as 'A' with only required fields filled
        When the user goes to OI Accounting Tab (Billing Based)
        When the user adds freights to OI MBL revenue
            | Bill to     | Freight code | Volume | Rate |
            | SHIPPER9191 | APHIS        | 9.293  | 165  |
        And the user clicks save button in OI Accounting Billing Based
        Then values in OI MBL revenue should be correct
            | No. | Amount  |
            | 1   | 1533.35 |
        When the user adds freights to OI HBL revenue
            | Bill to     | Freight code | Volume | Rate |
            | SHIPPER9191 | APHIS        | 9.293  | 165  |
        And the user clicks save button in OI Accounting Billing Based
        Then values in OI HBL revenue should be correct
            | No. | Amount  |
            | 1   | 1533.35 |
    ...
    Scenario: Creation, deletion, editing, and order test in accounting wizard
        ...
        And the user adds freights to OI MBL cost
            | Bill to  | Freight code      | Volume | Rate |
            | RAIL9191 | APHIS             | 1      | 1    |
            | RAIL9191 | APHIS             | 1      | 2    |
            | RAIL9191 | ALL IN CHARGE     | 1      | 3    |
        ...
        Then values in OI MBL revenue should be correct
            ...
            | 19  | 4      |
            | 20  | 5      |
        Then values in OI MBL cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
        ...
        # Step 12
        When the user deletes freights in OI MBL revenue
            | No. |
            | 5   |
            | 6   |
            | 7   |
        And the user adds freights to OI MBL cost
            ...
            | RAMP9191 | CCAM         | 1      | 200  |
        And the user clicks save button in OI Accounting Billing Based
        And the user changes currency of freights in OI MBL revenue
            | No. | Currency |
            | 8   | GBP      |
            | 9   | GBP      |
            | 10  | GBP      |
        ...
        Then values in OI MBL revenue should be correct
            ...
            | 16  | EUR      | 4      |
            | 17  | EUR      | 5      |
        And values in OI MBL cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
    ...
    Scenario: Freights' order, and 'copy to' function test
        ...
        And the user has a OI MBL with 1 HBL as 'A' with only required fields filled
        When the user goes to OI Accounting Tab (Billing Based)
        And the user adds freights to OI HBL cost
            | Bill to  | Freight code      | Volume | Rate |
            | RAIL9191 | APHIS             | 1      | 1    |
            | RAIL9191 | APHIS             | 1      | 2    |
            | RAIL9191 | ALL IN CHARGE     | 1      | 3    |
        ...
        And the user clicks save button in OI Accounting Billing Based
        Then values in OI HBL cost should be correct
            | No. | Amount |
            | 1   | 1      |
            | 2   | 2      |
            | 3   | 3      |
        ...
        # Step 15
        When the user copys freights from OI HBL cost to HBL revenue
            | No. |
            | 1   |
            | 2   |
            | 3   |
            ...
            | 9   |
            | 10  |
        And the user input freights information to OI HBL revenue
            | No. | Bill to     |
            | 1   | SHIPPER9191 |
            | 2   | SHIPPER9191 |
            | 3   | SHIPPER9191 |
            ...
            | 10  | SHIPPER9191 |
        And the user clicks save button in OI Accounting Billing Based
        And the user changes currency of freights in OI HBL revenue
            | No. | Currency |
            | 1   | EUR      |
        And the user deletes freights in OI HBL revenue
            | No. |
            | 2   |
            | 3   |
        And the user adds freights to OI HBL revenue
            | Bill to  | Freight code | Volume | Rate |
            | RAIL9191 | APHIS        | 1      | 11   |
        And the user deletes freights in OI HBL cost
            | No. |
            | 1   |
        And the user adds freights to OI HBL cost
            | Bill to  | Freight code | Volume | Rate |
    ...
    Scenario Outline: OI invoice Print style test
        # Step 16
        Given the company set 'Invoice Accounting Wizard Form Style' to '<style>' in 'Company Management' page
        And the user is a 'Operator'
        And the user has a OI MBL with 1 HBL as 'A' with only required fields filled
        When the user goes to OI Accounting Tab (Billing Based)
        And the user adds freights to OI MBL revenue
            | Bill to  | Freight code | Volume | Rate |
            | RAIL9191 | APHIS        | 1      | 1    |
        And the user clicks save button in OI Accounting Billing Based
        When the user clicks 'Action -> Print / Mail' to OI MBL revenue(1)
    ...
    Scenario: Permission test
        ...
        And the user clicks save button in OI Accounting Billing Based
        And the user blocks OI MBL revenue(1) in Accounting Billing Based
        ...
        Given the user is a 'Operator'
        When the user goes back to OI Shipment 'A'
        And the user goes to OI Accounting Tab (Billing Based)
        Then the unblock bottom in OI MBL revenue(1) should be invisible
        And the block bottom in OI MBL revenue(2) should be invisible
        When the user changes currency of freights in OI MBL revenue
            | No. | Currency |
            | 2   | EUR      |
