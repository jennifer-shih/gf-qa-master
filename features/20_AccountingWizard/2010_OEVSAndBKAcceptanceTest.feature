@MASCOT
Feature: [Accounting Wizard] Accounting Wizard Acceptance Test in Ocean Export Vessel Schedule plus Booking module

    Accounting Wiazrd acceptance test in OEVS + BK module, look up ticket GQT-161 for detail
